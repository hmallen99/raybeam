...
int main () {
    ...
    light* lt = new light();
    RayTracer* rt = new RayTracer(cam, lt, 720, 1280);
    vector<vec3> vecList = {
        vec3(-2, 1, -1),
        vec3(2, 1, -1),
        vec3(2, -1, -1),
    ...
    material* chrome = new metal(vec3(1, 1, 1));
    ...
    rt->addObject(new triangle(vecList[7], vecList[5], vecList[4], chrome));
    rt->addObject(new triangle(vecList[7], vecList[6], vecList[5], chrome));*/
    rt->addObject(new sphere(vec3(-1.0, 0, -1), 0.5, blue));
    rt->addObject(new sphere(vec3(0, 0, -1), 0.5, chrome));
    rt->addObject(new sphere(vec3(1, 0, -1), 0.5, red));
